...
<main>
    ...
    <div class="update-categories">
        <div class="update-categories-frame">
            <form action="/admin/categories/update/<?= $category['cat_id'] ?>" method="post" class="update-categories-form">
                <div class="update-categories-main">
                    ...
                    <div class="update-categories-main-color">
                        ...
                        <input type="color" name="cat_css_color" id="cat_css_color" value="<?= $category['cat_css_color'] ?>">
                    </div>
                </div>
