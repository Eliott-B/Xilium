        ...
        <?php foreach ($view_tickets as $v_ticket): ?>
            ...
            <div class="ticket-main" id=<?= $v_ticket[1]['tic_id'] ?>>
                ...
                <span class="ticket-category"
                      style="background-color: <?= $v_ticket[1]['category']['cat_css_color'] ?>">
                    <?= $v_ticket[1]['category']['cat_name'] ?>
                </span>
                    <span class="ticket-problem"
                ...
                <div class="ticket-main-actions">
                    <?php if ($v_ticket[1]['status']['sta_name'] !== "Fermé"): ?>
                        ...
                        if (($_SESSION['role'] == 10 ||
                            ...
                            $v_ticket[1]['tech_id'] === $_SESSION['id']): ?>
                            <button class="btn-tertiary"
                                    onclick="window.location.href='/desassignation/<?= $v_ticket[1]['tic_id'] ?>'">
                                Désattribuer
                            </button>
                        <?php endif; ?>
                        <?php if (($_SESSION['role'] == 50) && $v_ticket[1]['tech_id'] == NULL): ?>
                            <button class="btn-tertiary"
                                    onclick="window.location.href='/admin/give-ticket/<?= $v_ticket[1]['tic_id'] ?>'">
                                Attribuer
                                au tech
                            </button>
                        <?php endif; ?>
